...
const response = await fetch("systems/fortyk/imports/Xeno Components.json");
...
for (const [key, value] of Object.entries(content)) {
    ...
    let dataModel={};
    dataModel["name"]=key;
    dataModel["type"]="spaceshipComponent";
    let data={};
    data["power.value"]=value.Power;
    data["space.value"]=value.Space;
    data["type.value"]=value["Component type"];
    data["description.value"]=value.Notes;
