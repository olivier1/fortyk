...
returns the roll message*/
    ...
    static async energyHeadCrits(actor,num,ignoreSON){
        ...
        switch(num){
            ...
            case 5:
                ...
                await actor.createEmbeddedEntity("Item",{type:"injury",name:"Facial scarring"});
            ...
            case 6:
                ...
                await actor.createEmbeddedEntity("Item",{type:"injury",name:"Severe facial scarring"});
            ...
            case 7:
                ...
                actor.createEmbeddedEntity("Item",{name:"Permanently Blinded",type:"injury"});
                ...
                await actor.createEmbeddedEntity("Item",{type:"injury",name:"Blind"});
                await actor.createEmbeddedEntity("Item",{type:"injury",name:"Tremendous facial scarring"});
                break;
            case 8:
    ...
    static async energyBodyCrits(actor,num,ignoreSON){
        ...
        switch(num){
            ...
            case 8:
                ...
                await actor.createEmbeddedEntity("Item",{type:"injury",name:"Fourth degree chest burns."});
                this.applyActiveEffect(actorToken,critActiveEffect);
                break;
            case 9:
                await this.applyDead(actorToken,actor);
    ...
    static async explosiveBodyCrits(actor,num,ignoreSON){
        ...
        switch(num){
            ...
            case 5:
                ...
                await actor.createEmbeddedEntity("Item",{type:"injury",name:"Severe internal injuries"}); 
                this.applyActiveEffect(actorToken,critActiveEffect);
                break;
            case 6:
                critActiveEffect.push(duplicate(game.fortyk.FORTYK.StatusEffects[game.fortyk.FORTYK.StatusEffectsIndex.get("bleeding")]));
                ...
                await actor.createEmbeddedEntity("Item",{type:"injury",name:"Severe chest scars"}); 
                this.applyActiveEffect(actorToken,critActiveEffect);
                break;
            case 7:
                critActiveEffect.push(duplicate(game.fortyk.FORTYK.StatusEffects[game.fortyk.FORTYK.StatusEffectsIndex.get("prone")]));
    ...
    static async explosiveArmCrits(actor,num,arm,ignoreSON){
        ...
        switch(num){
            ...
            case 3:
                ...
                await actor.createEmbeddedEntity("Item",{type:"injury",name:arm+`hand missing ${d5Roll._total} fingers.`}); 
            ...
            case 5:
                ...
                if(!tTest.value){
                    ...
                    await actor.createEmbeddedEntity("Item",{type:"injury",name:"Scarred "+arm+" hand"}); 
                }else{
                    injury=duplicate(game.fortyk.FORTYK.StatusEffects[game.fortyk.FORTYK.StatusEffectsIndex.get("arm")]);
                    await this._createInjury(actor,"Lost "+arm+" hand",injury);
                }
    ...
    static async impactBodyCrits(actor,num,ignoreSON){
        ...
        switch(num){
            ...
            case 7:
                ...
                await actor.createEmbeddedEntity("Item",{type:"injury",name:d5Roll._total+" ribs broken"});
    ...
    static async impactArmCrits(actor,num,arm,ignoreSON){
        ...
        switch(num){
            ...
            case 5:
                critActiveEffect.push(duplicate(game.fortyk.FORTYK.StatusEffects[game.fortyk.FORTYK.StatusEffectsIndex.get("arm")]));
                await actor.createEmbeddedEntity("Item",{type:"injury",name:"Useless "+arm+" arm"});
                this.applyActiveEffect(actorToken,critActiveEffect);
                break;
            case 6:
                this._addFatigue(actor,1);
    ...
    static async rendingHeadCrits(actor,num,ignoreSON){
        ...
        switch(num){
            ...
            case 5:
                ...
                if(parseInt(actor.data.data.characterHitLocations.head.armor)===0){
                    await actor.createEmbeddedEntity("Item",{type:"injury",name:"Lost ear"});
    ...
    static async _createInjury(actor,injury,injuryAeData){
        ...
        await actor.createEmbeddedEntity("Item",injuryItem.data);
    };
}